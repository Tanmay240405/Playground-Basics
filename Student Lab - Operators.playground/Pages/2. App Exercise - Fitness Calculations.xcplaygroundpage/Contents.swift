...
let heartRated1: Double = 60
let heartRated2: Double = 70
let heartRated3: Double = 66
let addedHRD: Double = heartRated1 + heartRated2 + heartRated3
...
let percentSteps = (steps/goal) * 100
print(percentSteps)
