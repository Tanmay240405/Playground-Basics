...
let divisionResult = double10/double03
print(divisionResult)
print("we declared double10, double03 and divisionResult as double due to whish result is a double not an integer like previous answer")
...
print(rem1)
print(rem2)
print("if value is 0, then the number is a even one and if it is 1, then it is a odd one")
